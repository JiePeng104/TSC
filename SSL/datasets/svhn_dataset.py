...
from datasets.backdoor_dataset import CIFAR10Mem, CIFAR10Pair, BadEncoderTestBackdoor, ReferenceImg, \
...
classes = ['zero', 'one', 'two', 'three', 'four', 'five', 'six', 'seven', 'eight', 'nine', 'airplane', 'tench']
...
def get_downstream_svhn_ctrl(args, transform):
    training_file_name = 'train.npz'
    testing_file_name = 'test.npz'
