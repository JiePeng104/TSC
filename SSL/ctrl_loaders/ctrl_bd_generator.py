...
class ctrl:
    def __init__(self, args, train):
        ...
        self.train_poison_frequency_agent = PoisonFre(None, args.img_size[0], args.channel, args.window_size,
                                                      args.trigger_position, False,
                                                      True)  # PoisonFre(None, 32, [1, 2], 32, [15, 31], False, True)
        self.magnitude = 100
        ...
        self.test_poison_frequency_agent = PoisonFre(None, args.img_size[0], args.channel, args.window_size,
                                                      args.trigger_position, False,
                                                      True)  # PoisonFre(None, 32, [1, 2], 32, [15, 31], False, True)
        self.magnitude = 100
