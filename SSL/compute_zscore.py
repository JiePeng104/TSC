...
from imagenet import get_processing, getBackdoorImageNet, getBackdoorImageNet100_ImageText
...
def main(args):
    ...
    #                 poison_rate=prt)
    # test on smaller ImageNet100
    dataset = getBackdoorImageNet100_ImageText(
        trigger_file=trigger_file,
        train_transform=test_transform,
        test_transform=test_transform,
        reference_word='truck',
    ...
    # Using the subset to test the z-score
...
if __name__ == '__main__':
    ...
    parser.add_argument('--batch_size', default=128, type=int, help='Number of images in each batch')
    parser.add_argument('--gpu', default='0', type=str, help='gpu id')
    parser.add_argument('--id', default='', type=str, help='save id')
    parser.add_argument('--encoder_path', default='', type=str, help='encoder_path')
