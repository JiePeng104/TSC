...
def get_PointOnCurve_device(args, architecture, curve_model, t, train_loader, device, bn_updating=True):
    num_bends = curve_model.num_bends
...
def import_PointOnCurve_device(args, spmodel, architecture, curve_model, t, train_loader, device, bn_updating=True):
    num_bends = curve_model.num_bends
