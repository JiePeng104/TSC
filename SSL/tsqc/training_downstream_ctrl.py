...
def logging_unified_results(args):
    ...
    import pickle
    filename = f"RandomSeed_{args.ds_dataset}_{args.random_seed}_CurvePoint_{args.curve_t}_Ratio_{args.ratio}_FixStart_{args.fix_start}_FixEnd_{args.fix_end}_Epoch_{args.epochs}_TSPCEpoch_{args.TSPC_epoch}.pkl"
...
class mc_repair_Class():
    ...
    def set_result(self, result_file):
        ...
        save_path = 'record/' + result_file + f'/defense/stl10-mc_repair/'
    ...
    def curvePoint_trainingDownstream(self, args, original_model, encoder_train_loader,
                                      train_loader, test_loader_clean,
        ...
        for i in range(args.TSPC_epoch):
            ...
            cl_result1, adv_result1 = self.training_Downstream(args, model, architecture,
            ...
            cl_result2, adv_result2 = self.training_Downstream(args, model, architecture,
    ...
    def mitigation(self):
        ...
        args.num_classes = len(down_train_data.classes)
        self.curvePoint_trainingDownstream(args, model, train_clean_loader, down_train_loader, down_test_loader_clean,
    ...
    def training_Downstream(self, args, model_curve, architecture, curve_name,
        ...
        for i, t_value in enumerate(test_array):
            ...
            net = NeuralNet(input_size, [args.hidden_size_1, args.hidden_size_2], num_of_classes).to(self.device)
            ...
            for epoch in range(1, args.nn_epochs + 1):
                ...
                if epoch % 50 == 0:
                    ...
                    print(f'Test ASR:{bd_acc}, Test ACC: {clean_acc}')
