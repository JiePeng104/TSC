...
if __name__ == '__main__':
    ...
    parser.add_argument('--epochs', default=35, type=int,
                        help='Number of sweeps over the shadow dataset to inject the backdoor')
    ...
    parser.add_argument('--reference_word', default='', type=str,
                        help='reference word; only applicable when reference_type is text')
