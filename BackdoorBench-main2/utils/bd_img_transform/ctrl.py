...
class ctrl:
    def __init__(self, args, train):
        ...
        self.train_poison_frequency_agent = PoisonFre(None, args.img_size[0], args.trigger_channels, args.img_size[0],
                                                      args.pos_list, args.use_dct,
                                                      args.use_yuv)  # PoisonFre(None, 32, [1, 2], 32, [15, 31], False, True)
        self.magnitude = 100
        ...
        self.test_poison_frequency_agent = PoisonFre(None, args.img_size[0], args.trigger_channels, args.img_size[0],
                                                     args.pos_list, args.use_dct,
                                                     args.use_yuv)  # PoisonFre(None, 32, [1, 2], 32, [15, 31], False, True)
        self.magnitude = 100
