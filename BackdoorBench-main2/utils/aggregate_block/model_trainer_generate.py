...
def generate_cls_model(
    ...
    if model_name == 'resnet18':
        ...
        pretrained = True
        if pretrained==True:
            net = models.vgg19_bn(num_classes = 1000, pretrained=False, **kwargs)
        ...
        # TODO: Note that we replace the last classfier of VGG with one linear layer for fast permutation
        # The model after modification is same as in https://github.com/kuangliu/pytorch-cifar/blob/master/models/vgg.py
